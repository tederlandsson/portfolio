...
const experienceContent = [
  {
    ...
    description: ' Automating UI tests for React-based web pages and end-to-end customer flows with Node.js framework WebdriverIO.',
    bottomHeader: 'Technologies used',
    technologies: ['JavaScript', 'TypeScript', 'WebdriverIO', 'Azure DevOps'],
    icons: [javascriptIcon, typescriptIcon, reactIcon, pythonIcon],
  },
  {
